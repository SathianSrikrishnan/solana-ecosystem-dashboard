...
Generated: `2026-09-11T20:59:42.781822Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 436,164,464.97 SOL
...
- Collected: `2026-09-11T20:59:36.500051Z`
- Confidence: `high`
...
- Collected: `2026-09-11T20:59:41.736235Z`
- Confidence: `medium`
...
### Delinquent stake share: 0.69 percent
...
### Delinquent stake: 3,023,748.07 SOL
...
### Estimated non-vote TPS: 2,228.53 transactions/second
...
### Non-vote TPS vs recent sample median: 2.37 percent
...
### Slot time vs recent sample median: -1.04 percent
...
### Estimated total TPS: 4,380.87 transactions/second
...
### Latest official Solana news age: 3.30 days
...
### SOL 24-hour price change: 2.16 percent
...
### Solana application fees: 13,190,582.11 USD
...
- 7-day average change: `+14.6%`
- Direction is not a health verdict.

### Solana application revenue: 5,703,789.12 USD
...
- 7-day average change: `+7.5%`
- Direction is not a health verdict.

### Solana chain fees: 709,327.00 USD
...
- 7-day average change: `-11.4%`
- Direction is not a health verdict.

### Solana DeFi TVL: 5,857,020,904.00 USD
...
### Solana daily DEX volume: 2,921,890,110.01 USD
...
### Solana REV (chain fees + tracked Jito tips): 831,129.00 USD
...
- 7-day average change: `-13.7%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 16,605,852,898.00 USD
