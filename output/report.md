...
Generated: `2026-09-21T04:59:15.328202Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 439,705,491.34 SOL
...
- Collected: `2026-09-21T04:59:10.271610Z`
- Confidence: `high`
...
- Collected: `2026-09-21T04:59:14.107267Z`
- Confidence: `medium`
...
### Delinquent stake: 200,027.29 SOL
...
### Estimated non-vote TPS: 1,515.97 transactions/second
...
### Non-vote TPS vs recent sample median: -5.03 percent
...
### Slot time vs recent sample median: -0.88 percent
...
### Estimated total TPS: 4,076.42 transactions/second
...
### SOL 24-hour price change: 2.24 percent
...
### Solana application fees: 12,261,881.51 USD
...
- 7-day average change: `-4.7%`
- Direction is not a health verdict.

### Solana application revenue: 4,807,350.78 USD
...
- 7-day average change: `-9.2%`
- Direction is not a health verdict.

### Solana chain fees: 786,996.00 USD
...
- 7-day average change: `+2.2%`
- Direction is not a health verdict.

### Solana DeFi TVL: 6,176,629,115.00 USD
...
### Solana daily DEX volume: 1,456,094,412.36 USD
...
### Solana REV (chain fees + tracked Jito tips): 950,399.00 USD
...
- 7-day average change: `+5.0%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 15,805,470,018.00 USD
...
|---:|---|---:|---:|---:|---|
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,856,583.01 | 4.06% | 7.00% | current |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 15,828,383.70 | 3.60% | 0.00% | current |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,518,301.53 | 2.85% | 0.00% | current |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,252,587.79 | 2.56% | 5.00% | current |
| 5 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 9,788,818.02 | 2.23% | 0.00% | current |
| 6 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,251,354.09 | 2.10% | 7.00% | current |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 9,106,985.46 | 2.07% | 10.00% | current |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,443,839.59 | 1.69% | 7.00% | current |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,088,079.33 | 1.61% | 5.00% | current |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,572,007.01 | 1.49% | 0.00% | current |
