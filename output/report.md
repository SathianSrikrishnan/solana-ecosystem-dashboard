...
Generated: `2026-09-15T04:57:49.331396Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 436,654,767.42 SOL
...
### Latest stable Agave release age: 3.60 days
...
- Collected: `2026-09-15T04:57:47.763664Z`
- Confidence: `medium`
...
### Delinquent stake share: 0.59 percent
...
### Delinquent stake: 2,593,871.78 SOL
...
### Estimated non-vote TPS: 1,221.93 transactions/second
...
### Non-vote TPS vs recent sample median: -23.49 percent
...
### Estimated total TPS: 3,393.87 transactions/second
...
- Status: `ok`
- Source: Official Solana source / `RSS latest item: Solana: Building, Proving and Earning Trust in Public`
- Collected: `2026-09-15T04:57:49.331396Z`
- Confidence: `high`
...
### SOL 24-hour price change: 0.16 percent
...
### Solana application fees: 12,274,185.65 USD
...
- 7-day average change: `+22.6%`
- Direction is not a health verdict.

### Solana application revenue: 4,340,719.50 USD
...
- 7-day average change: `+12.9%`
- Direction is not a health verdict.

### Solana chain fees: 647,012.00 USD
...
- 7-day average change: `+18.9%`
- Direction is not a health verdict.

### Solana DeFi TVL: 5,835,523,109.00 USD
...
### Solana daily DEX volume: 1,463,307,371.85 USD
...
### Solana REV (chain fees + tracked Jito tips): 753,769.00 USD
...
- 7-day average change: `+17.5%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 16,354,077,829.00 USD
...
### Tracked Solana DeFi categories: 44 categories
...
### Top 10 stake share: 24.32 percent
...
### Top 25 stake share: 39.99 percent
...
|---:|---|---:|---:|---:|---|
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,757,711.87 | 4.04% | 7.00% | current |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 16,373,376.88 | 3.73% | 0.00% | current |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,492,604.95 | 2.84% | 0.00% | current |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,369,566.14 | 2.59% | 5.00% | current |
| 5 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 9,669,319.45 | 2.20% | 0.00% | current |
| 6 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,256,224.98 | 2.11% | 7.00% | current |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 9,035,102.59 | 2.06% | 10.00% | current |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,372,354.85 | 1.68% | 7.00% | current |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 6,944,775.01 | 1.58% | 5.00% | current |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,553,625.65 | 1.49% | 0.00% | current |
