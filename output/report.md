...
Generated: `2026-09-26T21:13:02.169574Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 437,325,040.17 SOL
...
- Collected: `2026-09-26T21:12:54.005633Z`
- Confidence: `high`
...
### Latest stable Agave release age: 8.40 days
...
- Collected: `2026-09-26T21:13:00.309928Z`
- Confidence: `medium`
...
### Delinquent stake: 217,614.08 SOL
...
### Estimated non-vote TPS: 2,286.03 transactions/second
...
### Non-vote TPS vs recent sample median: 9.36 percent
...
### Estimated slot time: 0.26 seconds
...
### Slot time vs recent sample median: -1.32 percent
...
### Estimated total TPS: 4,832.33 transactions/second
...
### Latest official Solana news age: 2.30 days
...
### SOL 24-hour price change: -0.45 percent
...
### Solana application fees: 15,310,646.22 USD
...
### Solana application revenue: 6,009,994.20 USD
...
- 7-day average change: `+19.4%`
- Direction is not a health verdict.

### Solana chain fees: 962,211.00 USD
...
- 7-day average change: `+29.8%`
- Direction is not a health verdict.

### Solana DeFi TVL: 6,484,950,214.00 USD
...
### Solana daily DEX volume: 2,613,053,225.63 USD
...
### Solana REV (chain fees + tracked Jito tips): 1,170,205.00 USD
...
- 7-day average change: `+32.5%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 17,688,257,382.00 USD
...
### Top 10 stake share: 24.61 percent
...
### Top 25 stake share: 39.82 percent
...
|---:|---|---:|---:|---:|---|
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,860,284.36 | 4.08% | 7.00% | current |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 15,799,204.35 | 3.61% | 0.00% | current |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,343,055.54 | 2.82% | 0.00% | current |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,222,560.60 | 2.56% | 5.00% | current |
| 5 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 10,836,561.81 | 2.48% | 0.00% | current |
| 6 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,237,101.73 | 2.11% | 7.00% | current |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 9,182,741.54 | 2.10% | 10.00% | current |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,606,180.70 | 1.74% | 7.00% | current |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,093,311.00 | 1.62% | 5.00% | current |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,506,504.78 | 1.49% | 0.00% | current |
