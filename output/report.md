...
Generated: `2026-09-18T20:56:17.716438Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 439,435,801.55 SOL
...
- Collected: `2026-09-18T20:56:09.123699Z`
- Confidence: `high`
...
### Latest stable Agave release age: 7.30 days
...
- Collected: `2026-09-18T20:56:15.972412Z`
- Confidence: `medium`
...
### Delinquent stake: 176,606.13 SOL
...
### Estimated non-vote TPS: 2,860.32 transactions/second
...
### Non-vote TPS vs recent sample median: 27.37 percent
...
### Slot time vs recent sample median: 2.27 percent
...
### Estimated total TPS: 5,326.70 transactions/second
...
### Latest official Solana news age: 2.80 days
...
### SOL 24-hour price change: 12.24 percent
...
### Solana application fees: 14,429,555.18 USD
...
- 7-day average change: `+5.2%`
- Direction is not a health verdict.

### Solana application revenue: 6,212,061.21 USD
...
- 7-day average change: `-1.8%`
- Direction is not a health verdict.

### Solana chain fees: 813,114.00 USD
...
- 7-day average change: `+5.9%`
- Direction is not a health verdict.

### Solana DeFi TVL: 5,782,044,410.00 USD
...
- 7-day average change: `-1.6%`
- Direction is not a health verdict.

### Solana daily DEX volume: 2,592,123,183.29 USD
...
### Solana REV (chain fees + tracked Jito tips): 989,396.00 USD
...
### Solana stablecoin circulating value: 15,773,623,642.00 USD
