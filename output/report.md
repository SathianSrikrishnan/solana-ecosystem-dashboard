...
Generated: `2026-09-19T04:41:03.880568Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 439,453,837.63 SOL
...
### Latest stable Agave release age: 7.60 days
...
- Status: `ok`
- Source: Anza Agave GitHub releases / `GitHub releases; latest stable tag v4.3.0-rc.1`
- Collected: `2026-09-19T04:41:02.282862Z`
- Confidence: `medium`
...
### Delinquent stake: 158,570.06 SOL
...
### Delinquent validators: 11 validators
...
### Estimated non-vote TPS: 1,955.07 transactions/second
...
### Non-vote TPS vs recent sample median: 20.32 percent
...
### Estimated slot time: 0.27 seconds
...
### Slot time vs recent sample median: 1.35 percent
...
### Estimated total TPS: 4,456.67 transactions/second
...
### Latest official Solana news age: 3.20 days
...
- Status: `ok`
- Source: Official Solana source / `RSS latest item: Project Harmonia Brings Institutional Tokenized Funds to Solana`
- Collected: `2026-09-19T04:41:03.880568Z`
- Confidence: `high`
...
### SOL 24-hour price change: 7.09 percent
...
### Solana application fees: 12,944,709.89 USD
...
- 7-day average change: `-4.8%`
- Direction is not a health verdict.

### Solana application revenue: 4,218,019.20 USD
...
- 7-day average change: `-13.1%`
- Direction is not a health verdict.

### Solana chain fees: Not available USD

Base and priority transaction fees paid to Solana.

**Why it matters:** Chain fees show demand for transaction execution.

- Status: `unavailable`
- Source: DeFiLlama / `summary/fees/solana?dataType=dailyFees`
- Collected: `2026-09-19T04:40:57.463961Z`
- Confidence: `experimental`
- Important limitation: This source could not be verified during refresh: DeFiLlama series must include fourteen complete UTC days

### Solana DeFi TVL: 5,951,019,242.00 USD
...
- 7-day average change: `-0.6%`
- Direction is not a health verdict.

### Solana daily DEX volume: 1,883,832,204.43 USD
...
### Solana REV (chain fees + tracked Jito tips): Not available USD

Chain fees plus tracked gross Jito MEV tips.

**Why it matters:** REV estimates value paid for blockspace and ordering.
...
### Solana stablecoin circulating value: 15,713,976,587.00 USD
...
### Solana protocols with tracked TVL: 395 protocols
...
### Top 10 stake share: 24.27 percent
...
### Top 25 stake share: 40.00 percent
...
|---:|---|---:|---:|---:|---|
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,815,472.40 | 4.05% | 7.00% | current |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 15,816,148.04 | 3.60% | 0.00% | current |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,510,307.73 | 2.85% | 0.00% | current |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,398,201.71 | 2.59% | 5.00% | current |
| 5 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 9,784,908.12 | 2.23% | 0.00% | current |
| 6 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,254,525.60 | 2.11% | 7.00% | current |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 9,077,527.04 | 2.06% | 10.00% | current |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,397,868.72 | 1.68% | 7.00% | current |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 7,085,577.98 | 1.61% | 5.00% | current |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,557,939.50 | 1.49% | 0.00% | current |
