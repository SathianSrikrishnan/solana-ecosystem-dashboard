...
Generated: `2026-09-08T11:23:47.797719Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 438,664,137.30 SOL
...
### Latest stable Agave release age: Not available days

The live ecosystem source could not be normalized.

**Why it matters:** This source contributes one bounded ecosystem signal.

- Status: `unavailable`
- Source: Anza Agave GitHub releases / `GitHub stable releases`
- Collected: `2026-09-08T11:23:36.377483Z`
- Confidence: `experimental`
- Important limitation: Source refresh failed visibly: HTTP Error 504: Gateway Timeout

### Stable Agave releases in 90 days: Not available releases
...
### Delinquent stake share: 0.19 percent
...
### Delinquent stake: 813,850.89 SOL
...
### Estimated non-vote TPS: 1,598.82 transactions/second
...
### Non-vote TPS vs recent sample median: 4.71 percent
...
### Slot time vs recent sample median: 1.06 percent
...
### Estimated total TPS: 3,691.27 transactions/second
...
### Latest official Solana news age: 1.20 days
...
### SOL 24-hour price change: -1.91 percent
...
### Solana application fees: 14,137,651.07 USD
...
- 7-day average change: `-10.8%`
- Direction is not a health verdict.

### Solana application revenue: 6,278,179.43 USD
...
- 7-day average change: `-14.5%`
- Direction is not a health verdict.

### Solana chain fees: 750,652.00 USD
...
- 7-day average change: `-30.2%`
- Direction is not a health verdict.

### Solana DeFi TVL: 5,993,062,620.00 USD
...
- 7-day average change: `+0.8%`
- Direction is not a health verdict.

### Solana daily DEX volume: 2,720,639,104.66 USD
...
### Solana REV (chain fees + tracked Jito tips): 875,451.00 USD
...
- 7-day average change: `-32.6%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 16,740,790,725.00 USD
