...
Generated: `2026-09-08T21:12:53.929113Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 438,600,953.75 SOL
...
- Collected: `2026-09-08T21:12:46.689052Z`
- Confidence: `high`
...
- Collected: `2026-09-08T21:12:53.591938Z`
- Confidence: `experimental`
- Important limitation: Source refresh failed visibly: HTTP Error 403: rate limit exceeded
...
### Delinquent stake: 52,551.00 SOL
...
### Estimated non-vote TPS: 2,250.78 transactions/second
...
### Non-vote TPS vs recent sample median: -1.38 percent
...
### Estimated total TPS: 4,363.52 transactions/second
...
### Latest official Solana news age: 0.30 days
...
- Status: `ok`
- Source: Official Solana source / `RSS latest item: Report: Stablecoins Are Reshaping Remittances`
- Collected: `2026-09-08T21:12:53.929113Z`
- Confidence: `high`
...
### SOL 24-hour price change: -0.57 percent
...
### Solana application fees: 14,137,632.07 USD
...
### Solana application revenue: 6,278,160.43 USD
...
### Top 10 stake share: 24.25 percent
...
### Top 25 stake share: 39.96 percent
...
|---:|---|---:|---:|---:|---|
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,436,766.29 | 3.98% | 7.00% | current |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 16,345,792.11 | 3.73% | 0.00% | current |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,527,540.03 | 2.86% | 0.00% | current |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,388,333.25 | 2.60% | 5.00% | current |
| 5 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 9,566,720.67 | 2.18% | 0.00% | current |
| 6 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,286,723.46 | 2.12% | 7.00% | current |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 9,027,480.90 | 2.06% | 10.00% | current |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,322,727.53 | 1.67% | 7.00% | current |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 6,860,585.29 | 1.56% | 5.00% | current |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,604,065.81 | 1.51% | 0.00% | current |
