...
Generated: `2026-09-07T12:37:57.781367Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 439,244,119.24 SOL
...
### Latest stable Agave release age: 9.70 days
...
- Status: `ok`
- Source: Anza Agave GitHub releases / `GitHub releases; latest stable tag v4.2.2`
- Collected: `2026-09-07T12:37:56.766792Z`
- Confidence: `medium`
...
### Delinquent stake share: 0.05 percent
...
### Delinquent stake: 233,868.94 SOL
...
### Estimated non-vote TPS: 1,758.10 transactions/second
...
### Non-vote TPS vs recent sample median: 26.69 percent
...
### Estimated slot time: 0.31 seconds
...
### Slot time vs recent sample median: -1.05 percent
...
### Estimated total TPS: 3,903.08 transactions/second
...
### Latest official Solana news age: 0.20 days
...
- Status: `ok`
- Source: Official Solana source / `RSS latest item: # How BitRobot Crowdsources Real-World Data for Embodied AI, with Jonathan Victor`
- Collected: `2026-09-07T12:37:57.781367Z`
- Confidence: `high`
...
### SOL 24-hour price change: -1.37 percent
...
### Solana application fees: 6,940,591.48 USD
...
- 7-day average change: `-24.8%`
- Direction is not a health verdict.

### Solana application revenue: 2,432,162.88 USD
...
### Solana DeFi TVL: 5,924,750,516.00 USD
...
- 7-day average change: `+0.9%`
- Direction is not a health verdict.

### Solana daily DEX volume: 1,305,326,306.81 USD
...
### Solana stablecoin circulating value: 16,686,042,306.00 USD
...
### Solana protocols with tracked TVL: 402 protocols
...
### Top 10 stake share: 24.19 percent
...
### Top 25 stake share: 39.87 percent
...
|---:|---|---:|---:|---:|---|
| 1 | `CcaHc2L43ZWjwCHART3oZoJvHLAe9hzT2DJNUpBzoTN1` | 17,438,540.52 | 3.97% | 7.00% | current |
| 2 | `he1iusunGwqrNtafDtLdhsUQDFvo13z9sUa36PauBtk` | 16,336,963.68 | 3.72% | 0.00% | current |
| 3 | `3N7s9zXMZ4QqvHQR15t5GNHyqc89KduzMP7423eWiD5g` | 12,517,399.06 | 2.85% | 0.00% | current |
| 4 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 11,397,824.23 | 2.59% | 5.00% | current |
| 5 | `8GbwASqdpw4dVcwbWUxbHXMrjyQx2aKkoBR5H1GJF8iD` | 9,564,411.53 | 2.18% | 0.00% | current |
| 6 | `26pV97Ce83ZQ6Kz9XT4td8tdoUFPTng8Fb8gPyc53dJx` | 9,181,909.19 | 2.09% | 7.00% | current |
| 7 | `51JBzSTU5rAM8gLAVQKgp4WoZerQcSqWC7BitBzgUNAm` | 9,038,443.43 | 2.06% | 10.00% | current |
| 8 | `9QU2QSxhb24FUX3Tu2FpczXjpK3VYrvRudywSZaM29mF` | 7,384,460.72 | 1.68% | 7.00% | current |
| 9 | `CvSb7wdQAFpHuSpTYTJnX5SYH4hCfQ9VuGnqrKaKwycB` | 6,858,928.88 | 1.56% | 5.00% | current |
| 10 | `DumiCKHVqoCQKD8roLApzR5Fit8qGV5fVQsJV9sTZk4a` | 6,595,420.72 | 1.50% | 0.00% | current |
