...
Generated: `2026-08-14T02:48:15.708729Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 434,609,826.97 SOL
...
### Latest stable Agave release age: 6.30 days
...
- Collected: `2026-08-14T02:48:14.433367Z`
- Confidence: `medium`
...
### Delinquent stake: 60,088.64 SOL
...
### Estimated non-vote TPS: 1,526.38 transactions/second
...
### Non-vote TPS vs recent sample median: -17.11 percent
...
### Estimated total TPS: 3,169.18 transactions/second
...
- Status: `ok`
- Source: Official Solana source / `RSS latest item: Why Asia Is Ahead on Stablecoins, According to Reap's Daren Guo`
- Collected: `2026-08-14T02:48:15.708729Z`
- Confidence: `high`
...
### SOL 24-hour price change: 0.54 percent
...
- Collected: `2026-08-14T02:48:08.174820Z`
- Confidence: `high`
...
### Solana application fees: 7,656,795.95 USD
...
### Solana application revenue: 3,576,169.79 USD
...
### Solana chain fees: 709,826.00 USD
...
- 7-day average change: `+25.1%`
- Direction is not a health verdict.

### Solana DeFi TVL: 4,832,290,674.00 USD
...
### Solana daily DEX volume: 1,768,427,220.23 USD
...
### Solana REV (chain fees + tracked Jito tips): 837,418.00 USD
...
- 7-day average change: `+22.8%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 16,080,626,457.00 USD
