...
Generated: `2026-08-29T16:45:05.128793Z`

**Current reading:** The selected Solana RPC endpoint reports healthy.

## What is happening now?

### Active stake: 436,095,615.19 SOL
...
- Collected: `2026-08-29T16:44:48.885695Z`
- Confidence: `high`
...
### Latest stable Agave release age: 15.90 days
...
- Collected: `2026-08-29T16:45:03.471110Z`
- Confidence: `medium`
...
### Delinquent stake: 38,673.95 SOL
...
### Estimated non-vote TPS: 2,136.77 transactions/second
...
### Non-vote TPS vs recent sample median: -5.21 percent
...
### Estimated total TPS: 4,293.03 transactions/second
...
### SOL 24-hour price change: -0.29 percent
...
### Solana application fees: 13,841,318.89 USD
...
- 7-day average change: `+38.5%`
- Direction is not a health verdict.

### Solana application revenue: 6,360,912.43 USD
...
- 7-day average change: `+33.0%`
- Direction is not a health verdict.

### Solana chain fees: 946,011.00 USD
...
- 7-day average change: `+27.0%`
- Direction is not a health verdict.

### Solana DeFi TVL: 6,012,977,669.00 USD
...
### Solana daily DEX volume: 2,590,586,442.22 USD
...
### Solana REV (chain fees + tracked Jito tips): 1,188,421.00 USD
...
- 7-day average change: `+34.4%`
- Direction is not a health verdict.

### Solana stablecoin circulating value: 16,381,381,393.00 USD
