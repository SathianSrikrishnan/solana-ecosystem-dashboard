...
class OfficialUpdatesTests(unittest.TestCase):
    def test_builds_news_and_upgrade_metrics_from_official_sources(self):
        ...
        alpenglow = "<h1>Alpenglow</h1><p>In Development</p><p>Expected Mainnet Activation Date</p><p>Q3 2026</p>"
        ...
        self.assertEqual(metrics["alpenglow_upgrade_status"]["value"], "In development · Q3 2026")
        self.assertEqual(metrics["simd_0525_status"]["value"], "Draft")

    def test_rejects_an_unrecognized_alpenglow_status(self):
        rss = """<?xml version="1.0"?><rss><channel><item><title>Solana ships</title><link>https://solana.com/news/ships</link><pubDate>Sun, 09 Aug 2026 12:00:00 GMT</pubDate></item></channel></rss>"""
        alpenglow = "<h1>Alpenglow</h1><p>Complete</p><p>Q3 2026</p>"
        simd = """simd | 0525\ntitle | Reduce Slot Times\nstatus | Draft"""

        with self.assertRaisesRegex(ValueError, "expected status"):
            parse_official_updates(
                rss,
                alpenglow,
                simd,
